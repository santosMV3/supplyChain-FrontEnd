            ...
            <Form style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        >
                                    ...
                                    <div style={{
                                        ...
                                        {excelData.seletorZZORDER.SheetNames.map((sheet, index) => (
                                            <div key={`zzorder-${index}`} style={{
                                                ...
                                                <input type="radio" onChange={handlerInputRadio} style={{width: '10%'}}
                                                       name="seletorZZORDER" value={sheet} id={sheet + "_id"}/>
                            ...
                            {loaderData.seletorZZORDER === undefined ? (
                                <div style={{width: '100%', height: '0px', overflow: 'hidden', transition: '0.5s'}}>
                                    <div className="progress-info">
                                        <div className="progress-percentage">
                                            {uploadStatus.seletorZZORDER === 'stable' ? (
                                                <span>
                                                    {loaderData?.seletorZZORDER ? loaderData.seletorZZORDER : 'Não enviado'}
                                                </span>
                                            ) : (
                                    ...
                                    <Progress max="100"
                                              value={loaderData?.seletorZZORDER ? loaderData.seletorZZORDER : 0}
                                              color={uploadStatus.seletorZZORDER !== 'unstable' ? 'success' : 'danger'}/>
                                </div>
                            ) : (
                        ...
                        <input type="file" onChange={handlerInputFile} id="seletorZZORDER" accept=".xlsx"
                               style={{display: "none"}}/>
                    </div>
                    <div style={{
                        display: "flex",
                        ...
                        >
                                    ...
                                    <div style={{
                                        ...
                                        {excelData.seletorLogMap.SheetNames.map((sheet, index) => (
                                            <div key={`logmap-${index}`} style={{
                                                ...
                                                <input type="radio" onChange={handlerInputRadio} style={{width: '10%'}}
                                                       name="seletorLogMap" value={sheet} id={sheet + "_id"}/>
                                                <label htmlFor={sheet + "_id"} style={{
                                                    fontFamily: 'Arial',
                                                    color: 'gray',
                                                    fontSize: '0.8em',
                            ...
                            {loaderData.seletorLogMap === undefined ? (
                                <div style={{width: '100%', height: '0px', overflow: 'hidden', transition: '0.5s'}}>
                                    <div className="progress-info">
                                        <div className="progress-percentage">
                                            {uploadStatus.seletorLogMap === 'stable' ? (
                                                <span>
                                                    {loaderData?.seletorLogMap ? loaderData.seletorLogMap : 'Não enviado'}
                                                </span>
                                            ) : (
                                                <span style={{width: '100%', textAlign: 'center'}}>
                                                    Upload Error
                                    ...
                                    <Progress max="100"
                                              value={loaderData?.seletorLogMap ? loaderData.seletorLogMap : 0}
                                              color={uploadStatus.seletorLogMap !== 'unstable' ? 'success' : 'danger'}/>
                                </div>
                            ) : (
                                <div style={{width: '100%', height: '58px', overflow: 'hidden', transition: '0.5s'}}>
                                    <div className="progress-info">
                                    ...
                                    <Progress max="100"
                                              value={loaderData.seletorLogMap === undefined ? 0 : loaderData.seletorLogMap}
                                              color={uploadStatus.seletorLogMap !== 'unstable' ? 'success' : 'danger'}/>
                                </div>
                            )}
                        </div>
                        <input type="file" onChange={handlerInputFile} id="seletorLogMap" accept=".xlsx"
                               style={{display: "none"}}/>
                    </div>
                </div>
                <div style={{
                    ...
                    <Button color={stateButtonZZORDER.color} onClick={sendExcelZZORDER} id="sendButtonZZORDER"
                            type="button">
                        {stateButtonZZORDER.text}
                    </Button>
                    <Button color={stateButtonLogMap.color} onClick={sendExcelBackLog} id="sendButtonLogMap"
                            type="button">
            ...
            <>
                <tr style={index % 2 === 0 ? null : {backgroundColor: '#dfdfdf', boxShadow: '0px 0px 5px gray'}}>
                    ...
                    <td>
                        <Media className="align-items-center">
                            <Media>
                                <span id={"prevSystem" + index} style={{
                                    fontSize: '1.0em',
                                    textOverflow: 'ellipsis',
                                    maxWidth: '20ch',
                                    overflow: 'hidden'
                    ...
                    <td>
                        <Media className="align-items-center">
                            <Media>
                                <span id={"openValueLocal" + index} style={{
                                    fontSize: '1.0em',
                                    textOverflow: 'ellipsis',
                                    maxWidth: '20ch',
                                    overflow: 'hidden'
                    ...
                    <td>
                        <Media className="align-items-center">
                            <Media>
                                <span id={"schedIDate" + index} style={{
                                    fontSize: '1.0em',
                                    textOverflow: 'ellipsis',
                                    maxWidth: '20ch',
                                    overflow: 'hidden'
                    ...
                    <td>
                        <Media className="align-items-center">
                            <Media>
                                <span id={"materialDescript" + index} style={{
                                    fontSize: '1.0em',
                                    textOverflow: 'ellipsis',
                                    maxWidth: '20ch',
                                    overflow: 'hidden'
                    ...
                    <td>
                        <Media className="align-items-center">
                            <Media>
                                <span id={"materialNumber" + index} style={{
                                    fontSize: '1.0em',
                                    textOverflow: 'ellipsis',
                                    maxWidth: '20ch',
                                    overflow: 'hidden'
                    ...
                    <td>
                        <Media className="align-items-center">
                            <Media>
                                <span id={"prevTrianom" + index} style={{
                                    fontSize: '1.0em',
                                    textOverflow: 'ellipsis',
                                    maxWidth: '20ch',
                                    overflow: 'hidden'
                                    ...
                                    <>
                                        <FormControl required className={classes.formControl}>
                                            ...
                                            >
                                                ...
                                                {statusData.map((status, index) => (
                                                    <MenuItem key={`status-${index}`} onClick={handleOptionChange}
                                                              value={`${status.idStatus}:${post.id}`}>
                                        ...
                                        <div style={{
                                            ...
                                            <Button color="success" size="sm"
                                                    onClick={status !== undefined ? updateStatusOrder : saveStatusOrder}>
                                                    ...
                                                    <>
                                                        <div style={{
                                                            ...
                                                            <div style={{
                                                                ...
                                                                <Input id="supplierExternal" placeholder="Supplier"
                                                                       defaultValue={supplier} type="text" style={{
                                                                    width: '200px',
                                                                    height: '30px'
                                                                }}/>
                                                                <Input id="daysExternal" placeholder="Return Days"
                                                                       defaultValue={returnDays} type="number" min="0"
                                                                       style={{
                                                                           width: '200px',
                                                                           height: '30px'
                                                                       }}/>
                                                            ...
                                                            <div style={{
                                                                ...
                                                                <Button color="primary" onClick={saveExternalMode}
                                                                        type="button" size="sm">
                                                                    Save
                                                                </Button>
                                                                <Button color="danger" onClick={closeExternalMode}
                                                                        type="button" size="sm">
                                                                    Cancel
                                                                </Button>
                                                            </div>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <Input onChange={handlerInputFilter} id="field" bsSize="sm" style={{marginBottom: '10px'}}
                               type="select">
                            <option value={false}>Fields</option>
                            {filterFields.map((filter, index) => (
                                <option key={`filter-${index}`} value={filter[0]}>{filter[1]}</option>))}
                        </Input>
                        <div style={{
                            width: '100%',
                            display: 'flex',
                            ...
                            {searchFilter.field !== "externalService" ? (
                                <Input id="value" value={searchFilter.value} onChange={handlerInputFilter} type="text"
                                       bsSize="sm" style={{width: '70%'}}/>
                            ) : (
                            ...
                            <Button color="info" disabled={searchFilter.field === "false" ? true : false}
                                    onClick={searchField} size="sm" type="button" style={{width: '20%'}}>
                                Search
                            </Button>
                        </div>
                    </div>
            ...
            {loaderList ? (
                ...
                <Table className="align-items-center" style={{
                    ...
                    {logMapData !== undefined ? (
                        <>
                            {logMapData.results.length > 0 ? logMapData.results.map((post, index) => (
                                <ListItem key={`listitem-${index}`} post={post} index={index}/>)) : (
                                <tr>
                                    <td colSpan="24">
                                        No data.
                                    </td>
                            ...
                            {logMapData.count > 0 ? (
                                <Pagination>
                                    ...
                                    <PaginationItem className="active">
                                        <PaginationLink style={{cursor: 'default'}} href="#"
                                                        onClick={e => e.preventDefault()}>
                                            {logMapData.page}
                                        </PaginationLink>
                                    </PaginationItem>
                                    {logMapData.next === null ? (
                                        <PaginationItem className="disabled">
                                            <PaginationLink style={{boxShadow: '0px 0px 5px gray'}} href="#"
                                                            onClick={e => e.preventDefault()}>
                                        ...
                                        <PaginationItem>
                                            <PaginationLink style={{boxShadow: '0px 0px 5px gray'}} href="#"
                                                            onClick={() => getData(logMapData.next)}>
                                                <i className="fa fa-angle-right"/>
                                                <span className="sr-only">Next</span>
                                            </PaginationLink>
                                        </PaginationItem>
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                <PaginationLink style={{
                                                    boxShadow: [expandState === false ? '0px 0px 5px gray' : '0px 0px 2px gray'],
                                                    margin: '0',
                                                    marginRight: '5px'
                                                }} href="#"
                                                ...
                                                <input type="number" value={goPage} max={logMapData.lastPage}
                                                       onChange={handlerGopage} min="1" style={{
                                                    width: '50px',
                                                    border: '0px',
                                                    boxShadow: '0px 0px 2px black',
                                                    borderRadius: '10px',
                                                ...
                                                <Button color="primary" style={{borderRadius: '10px'}}
                                                        onClick={() => goToPage(goPage)} outline size="sm"
                                                        type="button">
                                                    Go
                                                </Button>
                                            </div>
